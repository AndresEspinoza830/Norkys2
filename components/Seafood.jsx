                                            ...
                                            <div className="rounded-lg shadow-lg bg-white max-w-sm">
                                                ...
                                                <div className="p-6">
                                                    ...
                                                    <Link href={`/component/${smoothie.Name}`}>
                                                        <a type="button" className="inline-block px-6 py-2.5 bg-slate-800 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Link</a>
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
