                        ...
                        >
                            ...
                            <div className='flex items-center mb-5'>
                                ...
                                <div className='flex flex-row h-10 rounded-lg relative bg-transparent ml-4'>
                                    ...
                                    <input
                                        type="text"
                                        className="outline-none  border-[1px] focus:outline-none text-center  font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center"
                                        value={cantidad}
